...
CalculateThroughput()
{
    ...
    std::ofstream OFS("/home/kamran/ns-3/ns-allinone-3.38/ns-3.38/PositioningV5",
                      std::ios_base::app);
    if (OFS.is_open())
    {
...
main(int argc, char* argv[])
{
    CoordsList coordsListUe =
        loadCoordsFromFile("/home/kamran/ns-3/ns-allinone-"
                           "3.38/ns-3.38/scratch/positioningV6-kamran/ue.txt");
    CoordsList coordsListAp{loadCoordsFromFile("/home/kamran/ns-3/ns-allinone-"
                                               "3.38/ns-3.38/scratch/positioningV6-kamran/AP.txt")};
    ...
    {
        staPositionAllocator.Add(Vector(coordsListUe[i].x, coordsListUe[i].y, coordsListUe[i].z));
    }
    ...
    // for (uint32_t i = 0; i < nWifi; ++i)
    // {
    //     // positionAllocator.Add(Vector(coordsListAp[i].x, coordsListAp[i].y,
    //     coordsListAp[i].z));
